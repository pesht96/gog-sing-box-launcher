...
Current stable baseline: `v1.99-sb1137`
...
update_server/public/
  ...
  stable/
    ...
    packages/
      .gitkeep
      gog-update-v1.99-sb1137.tar.gz
      gog-update-v1.99-sb1137.tar.gz.sha256
    releases/
      v1.99-sb1137/
        notes.txt
```
...
signed `control_plane` package for `v1.99-sb1137`.

Current stable package:

```text
https://raw.githubusercontent.com/pesht96/gog-sing-box-launcher/main/update_server/public/stable/packages/gog-update-v1.99-sb1137.tar.gz
```

Current stable notes:

```text
https://raw.githubusercontent.com/pesht96/gog-sing-box-launcher/main/update_server/public/stable/releases/v1.99-sb1137/notes.txt
```
