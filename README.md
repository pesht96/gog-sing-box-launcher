...
Current stable baseline: `v2.00-sb1137`
...
update_server/public/
  ...
  stable/
    ...
    packages/
      .gitkeep
      gog-update-v2.00-sb1137.tar.gz
      gog-update-v2.00-sb1137.tar.gz.sha256
    releases/
      v2.00-sb1137/
        notes.txt
```
...
signed `control_plane` package for `v2.00-sb1137`.

Current stable package:

```text
https://gog-sing-box-launcher.pages.dev/stable/packages/gog-update-v2.00-sb1137.tar.gz
```

Current stable notes:

```text
https://gog-sing-box-launcher.pages.dev/stable/releases/v2.00-sb1137/notes.txt
```
