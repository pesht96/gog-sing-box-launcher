...
Current stable baseline: `v2.09-sb1137`
...
update_server/public/
  ...
  stable/
    ...
    packages/
      .gitkeep
      gog-update-v2.09-sb1137.tar.gz
      gog-update-v2.09-sb1137.tar.gz.sha256
    releases/
      v2.09-sb1137/
        notes.txt
  xray/
...
ordinary sing-box application/control-plane and adds narrow Naive outbound
support for inline `naive://` rows and recognized sing-box JSON Naive
outbounds.

Current stable package:

```text
https://gog-sing-box-launcher.pages.dev/stable/packages/gog-update-v2.09-sb1137.tar.gz
```

Current stable notes:

```text
https://gog-sing-box-launcher.pages.dev/stable/releases/v2.09-sb1137/notes.txt
```
